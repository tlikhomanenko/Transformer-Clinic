...
CUDA_VISIBLE_DEVICES=$GPUID fairseq-train ../data-bin/wmt14_en_fr_joined_dict \
	...
	--seed 1111 --restore-file x.pt --max-epoch 75 --save-dir wmt14enfr/wmt-admin-cape-6l-${gl} \
	--user-dir ../radam_fairseq --init-type adaptive-profiling \
    --profiling_path wmt14enfr/wmt-admin-cape-6l-${gl}/profile.ratio.init \
	--french --augmented-embedding --global-shift=${gl} \
	--log-format simple --log-interval 100 | tee ./wmt14enfr/log/loss-admin-cape-6l-${gl}.log
