...
fairseq-train \
    ...
    --save-dir wmt14ende/wmt-admin-fp32-${lnum}l --restore-file x.pt --seed 1111 \
    --user-dir ../radam_fairseq --log-format simple --log-interval 500 \
    --init-type adaptive-profiling --profiling_path wmt14ende/wmt-admin-fp32-${lnum}l/profile.ratio.init \
...
fairseq-train \
    ...
    --save-dir wmt14ende/wmt-admin-fp32-${lnum}l --restore-file x.pt --seed 1111 \
    --user-dir ../radam_fairseq --log-format simple --log-interval 500 \
    --init-type adaptive --profiling_path wmt14ende/wmt-admin-fp32-${lnum}l/profile.ratio.init \
    --encoder-layers $lnum --decoder-layers $lnum \
    --threshold-loss-scale 0.03125 | tee ./wmt14ende/log/loss_admin-${lnum}l.log

  bash eval_wmt_en-de.sh wmt14ende/wmt-admin-fp32-${lnum}l $GPUID 
