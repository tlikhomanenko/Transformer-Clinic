...
CUDA_VISIBLE_DEVICES=$GPUID fairseq-train ../data-bin/wmt14_en_fr_joined_dict \
	...
	--seed 1111 --restore-file x.pt --max-epoch 75 --save-dir wmt14enfr/wmt-admin-cape-6l-${gl}-int \
	...
	--log-format simple --log-interval 100 | tee ./wmt14enfr/log/loss-admin-cape-6l-${gl}-int.log
