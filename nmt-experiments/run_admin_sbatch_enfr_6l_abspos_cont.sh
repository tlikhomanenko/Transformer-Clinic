...
fairseq-train ../data-bin/wmt14_en_fr_joined_dict \
	...
	--seed 1111 --restore-file checkpoint_last.pt --max-epoch 50 --save-dir wmt14enfr/wmt-admin-abspos-6l \
	--user-dir ../radam_fairseq --init-type adaptive \
    --profiling_path wmt14enfr/wmt-admin-abspos-6l/profile.ratio.init \
	--encoder-learned-pos --decoder-learned-pos \
	--log-format simple --log-interval 100 | tee ./wmt14enfr/log/loss-admin-abspos-6l.log

bash eval_wmt_en-fr.sh ./wmt14enfr/log/wmt-admin-abspos-6l/ $GPUID
